		...
		>
			...
			<div class="fixed z-10 inset-0 overflow-y-auto">
				<div class="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
					<div class="relative bg-base-100 rounded-lg text-left overflow-hidden shadow-xl transform sm:my-8 sm:max-w-lg sm:w-full">
						<div class="bg-base-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
							<div class="sm:flex sm:items-start">
								...
								<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
									<h3 class="text-xl leading-6 font-medium text-base-content" id="modal-title">
										{title}
									</h3>
									<div class="mt-2">
										<div class="text-base text-neutral">{<Slot name="modalContent" />}</div>
									</div>
								</div>
							</div>
						</div>
